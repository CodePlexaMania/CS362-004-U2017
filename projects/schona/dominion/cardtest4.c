/*
	...
	CS362
	cardtest4.c
	- Testing VillageEffect
		Tests
			- Get one card from deck
			- Number of actions increase by 2
			- Played card count increases by 1
			- Village card discarded
			- VillageEffect returns 0
...
{
	printf("\n----------------------------------------\n");
	printf("cardtest4: Test VillageEffect function");
	printf("\n----------------------------------------\n");
	...
	//check VillageEffect returns 0
	AssertTrue(VillageEffect(0, 2, &postState) == 0, "VillageEffect returns 0");
